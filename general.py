...
'''
# path
data_path = "/Users/jiangyue/Desktop/DataVisualizationProject/"
...
advancedData = pd.read_csv(os.path.join(data_path, advanced), encoding="UTF-8",sep=',')
gameBasicData = pd.read_csv(os.path.join(data_path, pergame), encoding="UTF-8",sep=',')
